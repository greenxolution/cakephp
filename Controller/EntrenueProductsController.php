 ...
 */
class EntrenueProductsController extends AppController {
 ...
 */
	public function index() {
		...
		$this->Paginator->settings['conditions'] = $this->EntrenueProduct->parseCriteria($this->Prg->parsedParams());
		$this->set('entrenueProducts', $this->Paginator->paginate());
		
		
		$this->EntrenueProduct->recursive = 0;
// 		$this->set('entrenueProducts', $this->Paginator->paginate());
	}
