...
<?php echo $this->Form->create('ListOrderItem'); ?>
	<fieldset>
		<legend><?php echo __('Edit List Order Item'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ListOrderItem.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('ListOrderItem.id')))); ?></li>
