...
<?php echo $this->Form->create('TierBehavior'); ?>
	<fieldset>
		<legend><?php echo __('Edit Tier Behavior'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TierBehavior.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('TierBehavior.id')))); ?></li>
