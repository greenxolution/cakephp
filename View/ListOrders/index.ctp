<div class="listOrders index">
	...
	<?php 
		...
		$class = $listOrder['ListOrder']['OrderStatus'];
		
	?>
	<tr class="<?php echo $class;?>">
	
		<td><?php echo h($listOrder['ListOrder']['OrderStatus']); ?>&nbsp;</td>
		...
		foreach($listOrder['ListOrderItem'] as $item){
			
			echo '<tr><td>'.h('ASIN').'</td><td>'.h($item['ASIN']).'</td><tr>';
			echo '<tr><td>'.h('SellerSKU').'</td><td>'.h($item['SellerSKU']).'</td><tr>';
		}
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Detail'), array('action' => 'detail', $listOrder['ListOrder']['id'])); ?>
			<?php //echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $listOrder['ListOrder']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $listOrder['ListOrder']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
