...
<?php echo $this->Form->create('EntrenueProduct'); ?>
	<fieldset>
		<legend><?php echo __('Edit Entrenue Product'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('EntrenueProduct.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('EntrenueProduct.id')))); ?></li>
