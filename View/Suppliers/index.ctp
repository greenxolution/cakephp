<div class="suppliers index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('drop_email'); ?></th>
			<th><?php echo $this->Paginator->sort('notes'); ?></th>
			<th><?php echo $this->Paginator->sort('product_table'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($supplier['Supplier']['drop_email']); ?>&nbsp;</td>
		<td><?php echo h($supplier['Supplier']['notes']); ?>&nbsp;</td>
		<td><?php echo h($supplier['Supplier']['product_table']); ?>&nbsp;</td>
		<td><?php echo h($supplier['Supplier']['created']); ?>&nbsp;</td>
		<td><?php echo h($supplier['Supplier']['updated']); ?>&nbsp;</td>
		<td class="actions">
