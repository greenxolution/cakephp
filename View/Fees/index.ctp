<div class="fees index">
	...
	<tr>
		...
		<td><?php echo h($fee['Fee']['description']); ?>&nbsp;</td>
		<td><?php echo h($fee['Fee']['unit']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($fee['Supplier']['name'], array('controller' => 'suppliers', 'action' => 'view', $fee['Supplier']['id'])); ?>
		</td>
		<td><?php echo h($fee['Fee']['created']); ?>&nbsp;</td>
		<td><?php echo h($fee['Fee']['updated']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $fee['Fee']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $fee['Fee']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $fee['Fee']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $fee['Fee']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
