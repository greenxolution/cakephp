...
<?php echo $this->Form->create('ViewInventorySupplier'); ?>
	<fieldset>
		<legend><?php echo __('Edit View Inventory Supplier'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ViewInventorySupplier.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('ViewInventorySupplier.id')))); ?></li>
