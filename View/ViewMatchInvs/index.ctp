<div class="viewMatchInvs index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('l_price'); ?></th>
	...
	<tr>
		...
		<td><?php echo $this->Html->link($viewMatchInv['ViewMatchInv']['m_sku'], array('controller' => 'MwsInventories', 'action' => 'view', $viewMatchInv['ViewMatchInv']['id'])); ?>&nbsp;</td>
		...
		<td><?php echo h($viewMatchInv['ViewMatchInv']['l_price']); ?>&nbsp;</td>
		<td><?php echo round(h($viewMatchInv['ViewMatchInv']['profit']), 2); ?>&nbsp;</td>
		<td><?php echo round(h($viewMatchInv['ViewMatchInv']['earnings']), 2); ?>&nbsp;</td>
